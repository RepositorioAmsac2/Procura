...
{
    public partial class Frm_Inclusion_Pac_ConRequerimiento : Form
    {
        ...
        public Frm_Inclusion_Pac_ConRequerimiento()
        {
            InitializeComponent();
        }
        ...
        private bool VerificaIngresoMovimiento()
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (MyStuff.UsaWCF == true)
                    {
                        intIdPac_Deralle = objWCF.Recupera_Pac_Detalle_Codigo(this.Txt_NumProcedimiento.Text).iIdProcesoLogistico_Detalle;
                    }
                    else
                    {
        ...
        private void Btn_TipoProcedimientoAutomatico_Click(object sender, EventArgs e)
        {
            ...
            if (MyStuff.UsaWCF == true)
            {
                string[] Codigo = objWCF.hallarTipoProcedimiento_Pac_Detalle(MPC.cAñoProceso,
                                                                        MPC.cVersion,
