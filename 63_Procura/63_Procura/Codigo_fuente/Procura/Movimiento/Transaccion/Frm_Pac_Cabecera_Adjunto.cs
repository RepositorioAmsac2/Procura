...
{
    public partial class Frm_Pac_Cabecera_Adjunto : Form
    {
        ...
        public Frm_Pac_Cabecera_Adjunto()
        {
            InitializeComponent();
        }

        public void ShowMe(string cAñoProceso,
                            string cVersion,
                          ...
                          )
         {
            ...
            {
                dtGrilla = objWCF.Lista_Pac_Cabecera_Adjunto(strAñoProceso, strVersion).Tables[0];
            }
            else
            {
                dtGrilla = sdl.Lista_ProcesoLogistico_Cabecera_Adjunto(strAñoProceso, strVersion).Tables[0];
            }
            ...
            if (dtGrilla.Rows.Count > 0)
            {
                foreach (DataRow oRow in dtGrilla.Rows)
                {
                    ...
                    MPPA.CañoProceso = Convert.ToString(oRow["CañoProceso"]);
                    MPPA.Cversion = Convert.ToString(oRow["Cversion"]);
        ...
        private void MostrarDocumento(Model.ProcesoLogistico_Cabecera_Adjunto obj)
        {
        ...
        private void PintarDatosRegistro()
        {
            ...
            oRow.Cells[1].Value = MPPA.CañoProceso;
            oRow.Cells[2].Value = MPPA.Cversion;
        ...
        private void Grd_Adjunto_AfterSelectChange(object sender, Infragistics.Win.UltraWinGrid.AfterSelectChangeEventArgs e)
        {
            if (dtGrilla.Rows.Count > 0)
            {
                ...
                if ((oRow.Cells[0].Text).Trim() != "")
                {
                    ...
                    MPPA.CañoProceso = Convert.ToString(oRow.Cells[1].Value);
                    MPPA.Cversion = Convert.ToString(oRow.Cells[2].Value);
        ...
        {
            intIdAdjunto = 0;
            MostrarDocumento(new Model.ProcesoLogistico_Cabecera_Adjunto());
        ...
        private void Btn_Eliminar_Click(object sender, EventArgs e)
        {
            ...
            if (intEliminaRegistro == DialogResult.Yes)
            {
                ...
                if (MyStuff.UsaWCF == true)
                {
                    blnResultado = objWCF.Elimina_Pac_Cabecera_Adjunto(MPPA.IidAdjunto);
                }
                else
                {
                    blnResultado = sdl.Elimina_ProcesoLogistico_Cabecera_Adjunto(MPPA.IidAdjunto);
                }
        ...
        private void pintarGrilla()
        {
            ...
            oBand0.Columns[4].Header.Caption = "Nombre del Archivo";
            oBand0.Columns[4].Width = 425;
            oBand0.Columns[5].Header.Caption = "Creado";
        ...
        private void Btn_Grabar_Click(object sender, EventArgs e)
        {
            if (VerificaIngresoMovimiento())
            {
                ...
                MPPA.CañoProceso = strAñoProceso;
                MPPA.Cversion = strVersion;
                ...
                if (MyStuff.UsaWCF == true)
                {
                    intIdAdjunto = objWCF.Graba_Pac_Cabecera_Adjunto(MPPA);
                }
                else
                {
                    intIdAdjunto = sdl.Graba_ProcesoLogistico_Cabecera_Adjunto(MPPA);
                }
        ...
        private void Archivos()
        {
            ...
            string strRutaInicial = ""; // Environment.CurrentDirectory();
