...
{
    public partial class Frm_Incluir_Pac: Form
    {
        ...
        private bool Grabar_PAC()
        {
            ...
            if (frm.blnGrabar == true)
            {
                ...
                MPD.tDesJustificacion = Convert.ToString(this.Edt_Justificacion.Value);
        ...
        private void Frm_Incluir_Pac_Load(object sender, EventArgs e)
        {
