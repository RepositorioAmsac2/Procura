...
{
    public partial class Frm_ConsultaPac_Adjunto : Form
    {
        ...
        public Frm_ConsultaPac_Adjunto()
        {
            InitializeComponent();
        }
        ...
        public void ShowMe( string strNumProcedimiento)
        {
            ...
            {
                dtGrilla = objWCF.Lista_Pac_Adjunto_Consulta(strNumProcedimiento).Tables[0];
            }
            else
            {
                dtGrilla = sdl.Lista_ProcesoLogistico_Adjunto_Consulta(strNumProcedimiento).Tables[0];
            }
