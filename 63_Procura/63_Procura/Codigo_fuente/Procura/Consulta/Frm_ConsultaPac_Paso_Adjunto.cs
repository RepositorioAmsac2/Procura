...
{
    public partial class Frm_ConsultaPac_Paso_Adjunto : Form
    {
        ...
        public Frm_ConsultaPac_Paso_Adjunto()
        {
            InitializeComponent();
        }
            ...
            )
        {
            ...
            {
                dtGrilla = objWCF.Lista_Pac_Paso_Adjunto_Consulta(strNumProcedimiento, strCodPaso).Tables[0];
            }
            else
            {
                dtGrilla = sdl.Lista_ProcesoLogistico_Paso_Adjunto_Consulta(strNumProcedimiento, strCodPaso).Tables[0];
            }
