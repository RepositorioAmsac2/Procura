...
namespace WINlogistica
{
    public partial class Frm_ControlItemPAC : Form
    {
        ...
        private Service.Varios SV = new Service.Varios();

        private Model.ParametroLogistica MPL = new Model.ParametroLogistica();
        private Service.DataLogistica sdl = new Service.DataLogistica();

        private Model.Empleado ME = new Model.Empleado();
        private Service.Empleado SE = new Service.Empleado();
        ...
        {
            this.Cbo_PeriodoProceso.CargaDT(SV.Combo_PeriodoProceso().Tables[0]);
            if (Convert.ToString(this.Cbo_PeriodoProceso.SelectedValue).Trim() != "")
            {
                ...
                {
                    this.Cbo_Version.CargaDT(SV.Combo_Version(Convert.ToString(this.Cbo_PeriodoProceso.SelectedValue).Trim()).Tables[0]);
                }
            ...
            else
            {
                ...
                {
                    this.Cbo_Version.CargaDT(SV.Combo_Version(Convert.ToString(MyStuff.AñoProceso).TrimEnd()).Tables[0]);
                }
        ...
        private void verOperadorLogistico(string strCodOperadorLogistico)
        {
            ...
            {
                ME = SE.Recupera_Empleado_Codigo(strCodOperadorLogistico);
            }
        ...
        private void Cbo_PeriodoProceso_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (this.Cbo_PeriodoProceso.SelectedValue.ToString() != "System.Data.DataRowView")
            {
                ...
                {
                    this.Cbo_Version.CargaDT(SV.Combo_Version(Convert.ToString(MyStuff.AñoProceso).Trim()).Tables[0]);
                }
            }
        }
