...
#pragma warning restore CS0414 // El campo 'FM_Principal.strCodEmpleado' está asignado pero su valor nunca se usa
        ...
        private void accordionControlElement12_Click(object sender, EventArgs e)
        {
            ...
            if (!container.Controls.Contains(UC_Lista_Grafico.Instance))
            {
                container.Controls.Add(UC_Lista_Grafico.Instance);
                UC_Lista_Grafico.Instance.Dock = DockStyle.Fill;
                UC_Lista_Grafico.Instance.BringToFront();
            }
            UC_Lista_Grafico.Instance.BringToFront();
