...
{
    public partial class UC_Grafico_Gantt_Reporte : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public UC_Grafico_Gantt_Reporte()
        {
            InitializeComponent();
            this.lista();
        ...
        private static UC_Grafico_Gantt_Reporte _instance;
        public static UC_Grafico_Gantt_Reporte Instance
        {
            get
            {
                if (_instance == null)
                    _instance = new UC_Grafico_Gantt_Reporte();
                return _instance;
            }
        }
        ...
        private void Btn_Nuevo_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            SplashScreenManager.Default.SetWaitFormDescription("Trayendo grafico del Gantt...");
            WINlogistica.Form_Gantt frm = new WINlogistica.Form_Gantt();
