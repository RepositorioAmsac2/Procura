...
{
    public partial class UC_Seguimiento_PAC : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        private static UC_Seguimiento_PAC _instance;
        public static UC_Seguimiento_PAC Instance
        {
            get
            {
                if (_instance == null)
                    _instance = new UC_Seguimiento_PAC();
                return _instance;
            }
        }
