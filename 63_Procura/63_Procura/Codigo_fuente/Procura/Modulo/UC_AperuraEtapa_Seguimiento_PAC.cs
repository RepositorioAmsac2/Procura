...
{
    public partial class UC_AperuraEtapa_Seguimiento_PAC : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public UC_AperuraEtapa_Seguimiento_PAC()
        {
            InitializeComponent();
            this.lista();
        ...
        private static UC_AperuraEtapa_Seguimiento_PAC _instance;
        public static UC_AperuraEtapa_Seguimiento_PAC Instance
        {
            get
            {
                if (_instance == null)
                    _instance = new UC_AperuraEtapa_Seguimiento_PAC();
                return _instance;
            }
        }
        ...
        private void lista()
        {
            ...
            {
                dt = objDATA.Lista_ProcesoLogistico_Detalle_AperturaEtapa().Tables[0];
            }
        ...
        private void Btn_AperturaEtapa_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            SplashScreenManager.Default.SetWaitFormDescription("Trayendo hoja de control...");
            ...
            frm.ShowMe(strNumProcedimiento, intExcluido);
            SplashScreenManager.CloseForm();
            frm.ShowDialog();

            if (frm.blnGrabaApertura)
            {
                this.lista();
                this.Habilitar_Arriba_Abajo();
            }
