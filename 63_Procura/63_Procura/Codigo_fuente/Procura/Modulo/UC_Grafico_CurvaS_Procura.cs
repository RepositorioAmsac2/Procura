...
{
    public partial class UC_Grafico_CurvaS_Procura : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public UC_Grafico_CurvaS_Procura()
        {
            InitializeComponent();
            this.lista();
        ...
        private static UC_Grafico_CurvaS_Procura _instance;
        public static UC_Grafico_CurvaS_Procura Instance
        {
            get
            {
                if (_instance == null)
                    _instance = new UC_Grafico_CurvaS_Procura();
                return _instance;
            }
        }
