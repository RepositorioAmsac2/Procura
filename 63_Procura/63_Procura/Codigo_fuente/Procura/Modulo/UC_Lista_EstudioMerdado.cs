...
{
    public partial class UC_Lista_EstudioMerdado : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public UC_Lista_EstudioMerdado()
        {
            InitializeComponent();
            this.lista();
        ...
        private static UC_Lista_EstudioMerdado _instance;
        public static UC_Lista_EstudioMerdado Instance
        {
            get
            {
                if (_instance == null)
                    _instance = new UC_Lista_EstudioMerdado();
                return _instance;
            }
        }
        ...
        private void lista()
        {
            ...
            {
                dt = objDATA.Lista_ProcesoLogistico_Detalle_Cotizaciones().Tables[0];
            }
        ...
        private void Btn_EstudioMercado_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            SplashScreenManager.Default.SetWaitFormDescription("Trayendo lista de cotizaciones...");
            WINlogistica.UC_Reporte_Cotizaciones frm = new WINlogistica.UC_Reporte_Cotizaciones();
