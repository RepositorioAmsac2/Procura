...
{
    public partial class UC_Lista_CurvaS_Procura : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public UC_Lista_CurvaS_Procura()
        {
            InitializeComponent();
            this.lista();
        ...
        private static UC_Lista_CurvaS_Procura _instance;
        public static UC_Lista_CurvaS_Procura Instance
        {
            get
            {
                if (_instance == null)
                    _instance = new UC_Lista_CurvaS_Procura();
                return _instance;
            }
        }
        ...
        private void Btn_Nuevo_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            frm.ShowMe(strNumProcedimiento, "Procura");
