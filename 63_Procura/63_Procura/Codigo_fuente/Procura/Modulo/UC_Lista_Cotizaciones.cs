...
{
    public partial class UC_Lista_Cotizaciones : DevExpress.XtraEditors.XtraUserControl
    {
        private Model.CentroCosto centrocostopendiente = new Model.CentroCosto();
        //private SRsafnet.SAFnetEClient objWCF = new SRsafnet.SAFnetEClient();
        private Service.Data objDATA = new Service.Data();
        public UC_Lista_Cotizaciones()
        {
            InitializeComponent();
            this.lista();
        ...
        private static UC_Lista_Cotizaciones _instance;
        public static UC_Lista_Cotizaciones Instance
        {
            get
            {
                if (_instance == null)
                    _instance = new UC_Lista_Cotizaciones();
                return _instance;
            }
        }
