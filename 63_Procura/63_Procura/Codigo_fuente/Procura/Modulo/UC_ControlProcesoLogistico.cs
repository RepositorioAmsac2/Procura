...
{
    public partial class UC_ControlProcesoLogistico : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public UC_ControlProcesoLogistico()
        {
            InitializeComponent();
            this.lista();
        ...
        private static UC_ControlProcesoLogistico _instance;
        public static UC_ControlProcesoLogistico Instance
        {
            get
            {
                if (_instance == null)
                    _instance = new UC_ControlProcesoLogistico();
                return _instance;
            }
        }
        ...
        private void Btn_ControlEtapa_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
