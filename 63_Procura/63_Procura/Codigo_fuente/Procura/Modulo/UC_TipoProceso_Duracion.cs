...
{
    public partial class UC_TipoProceso_Duracion : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public UC_TipoProceso_Duracion()
        {
            InitializeComponent();
        }

        private static UC_TipoProceso_Duracion _instance;
        public static UC_TipoProceso_Duracion Instance
        {
            get
            {
                if (_instance == null)
                    _instance = new UC_TipoProceso_Duracion();
                return _instance;
            }
        }
        ...
        private bool VerificaIngresoMovimiento()
        {
            ...
            try
            {
                ...
                if ( Convert.ToInt32(  this.Cbo_codPasoActoPrevio.SelectedValue) == 0)
                {
                    blnVerifica = false;
        ...
        private void Btn_Mostrar_Click(object sender, EventArgs e)
        {
            ...
            if ( string.IsNullOrEmpty( strCodObjetoContratacion ) == false )
            {
                ...
                else
                {
                    ...
                    this.Cbo_codPasoActoPrevio.CargaDT(sdl.Combo_Paso_ID(MTP.cCodTipoPlantilla).Tables[0]);
                }
