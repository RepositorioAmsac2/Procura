...
{
    public partial class UC_Lista_CurvaS_Reporte : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public UC_Lista_CurvaS_Reporte()
        {
            InitializeComponent();
            this.lista();
        ...
        private static UC_Lista_CurvaS_Reporte _instance;
        public static UC_Lista_CurvaS_Reporte Instance
        {
            get
            {
                if (_instance == null)
                    _instance = new UC_Lista_CurvaS_Reporte();
                return _instance;
            }
        }
