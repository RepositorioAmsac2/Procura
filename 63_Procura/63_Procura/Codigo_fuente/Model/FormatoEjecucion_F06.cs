...
namespace Model
{
    public class FormatoEjecucion_F06
    {
        ...
        public string cDocPrecedenteCP { get; set; } = "";
        public string cReferencia { get; set; } = "";
        public string cDocReferenciaPago { get; set; } = "";
        public string cDocReferencia { get; set; } = "";
        public string cDocControl { get; set; } = "";
        ...
        public string cPosicionConcluida { get; set; } = "";
